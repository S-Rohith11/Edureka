    ...
    render(){
        ...
        return(
            <div>
                ...
                <nav class="navbar">
                    <div class="container">
                        <div class="navbar text-danger">
                            <h2 class="logo">e!</h2>
                        </div>
                        <form class="d-flex nav-form" style={{marginTop:"-18px"}}>
                ...
                <div className="container">
                    <div className="bannerCover">
                        <img src={restaurant.thumb} alt="banner" className="banner" />
                    ...
                    <div>
                        <input type="button" className="btn order_button" value="Place Online Order" />
                    </div>
                    ...
                    <div className="tabs">
                        <div className="tab">
                            ...
                            <label htmlFor="tab-1" className="subheaders" > Overview</label>
                        ...
                        <div className="tab ms-4">
                            ...
                            <label htmlFor="tab-2" className="subheaders" >Contact</label>
